      ...
      >
        ...
        <div class="dfrb">
          <el-form-item
            label="原计划"
            prop="oldPlan"
            :rules="{ required: true, message: '原计划不得为空' }"
            class="text-line"
          >
            <el-input
              placeholder="请输入原计划"
          ...
          <el-form-item
            label="结果"
            prop="result"
            :rules="{ required: true, message: '结果不得为空' }"
            class="text-line"
          >
            <el-input
              placeholder="请输入结果"
        ...
        <div class="dfrb">
          <el-form-item
            label="分析原因"
            prop="cause"
            :rules="{ required: true, message: '分析原因不得为空' }"
            class="text-line"
          >
            <el-input
              placeholder="请输入分析原因"
          ...
          <el-form-item
            label="确认根本原因"
            prop="confirmCause"
            :rules="{ required: true, message: '确认根本原因不得为空' }"
            class="text-line"
          >
            <el-input
        ...
        <el-form-item
          label="重来一次"
          prop="again"
          :rules="{ required: true, message: '重来一次不得为空' }"
          class="text-line"
        >
          <el-input
            placeholder="请输入重来一次"
