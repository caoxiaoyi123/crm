    ...
    <div class="detailed">
        ...
        <div class="table-box">
            ...
            >
                ...
                <el-table-column align="center" min-width="100" label="姓名" prop="person"></el-table-column>
                <el-table-column align="left" min-width="200" header-align="center" label="单位" prop="company">
                ...
                <el-table-column align="center" min-width="100" label="销售人员" prop="allotUserName"></el-table-column>
                ...
                <el-table-column align="center" min-width="100"  label="处理阶段" prop="status">
                    <template slot-scope="scope">
                        <span v-if="scope.row.status == '未处理'" class="red-txt fs14">待处理</span>
                        <span v-else-if="scope.row.status == '进行中'" class="yellow-txt fs14">处理中</span>
    ...
    methods: {
        ...
        exportFn() {//导出
            window.open(
                ...
                // "&end=" +this.data.end,
                // "_blank"
                baseUrl +"/so/report/server/detail/excel","_blank"
            );
        },
        getDepart(){//获取组织关系
