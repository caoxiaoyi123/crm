    ...
    <div class="servicePlan">
        ...
        <div class="table-box">
            ...
            >
                ...
                <el-table-column align="center" label="计划项数" prop="detailTotal"></el-table-column>
                <el-table-column align="center" label="附件">
                    <template slot-scope="scope">
                        <span @click="previewFn(scope.row)" class="cp draw-tit" v-if="scope.row.pubFileEntity">查看</span>
                    </template>
                </el-table-column>
    ...
    methods: {
        ...
        previewFn(row) {
            if (
                ...
                this.openPdf(baseUrl + "/so/file/view?fileId=" + row.pubFileEntity.fileId+"&fileName="+row.pubFileEntity.fileName);
            } else {
                this.openLink(baseUrl + "/so/file/view?fileId=" + row.pubFileEntity.fileId);
            }
        },
        pageNoChange(val) {
