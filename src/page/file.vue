        ...
        <div class="table-box">
            ...
            >
                <el-table-column
                    ...
                    type="index"
                ></el-table-column>
                <el-table-column align="left" header-align="center" label="文档名称" prop="fileName"></el-table-column>
                <el-table-column align="center" label="上传人" prop="userName"></el-table-column>
        ...
        <v-drawer :title="'上传'" :drawer="drawer">
            ...
            >
                <el-form-item label="文档名称" prop="fileName">
                    <el-input placeholder="请输入文档名称" :disabled="disabled"  v-model="fromData.fileName"></el-input>
                </el-form-item>
                <el-form-item label="上传附件">
                    ...
                    >
                        <button :disabled="disabled" class="fs12 text-c cp upload-btn" :class="disabled?'ban':''">{{btnTxt}}</button>
                    </el-upload>
                </el-form-item>
            </el-form>
        </v-drawer>
