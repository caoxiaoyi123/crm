    ...
    <div class="service">
        ...
        <div class="table-box">
            ...
            >
                ...
                <el-table-column align="center" label="服务人员" prop="person"></el-table-column>
                ...
                <el-table-column align="center" label="操作">
                    <template slot-scope="scope">
                        <span class="draw-tit cp fs14" @click="feedbackFn(scope.row)">反馈</span>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <v-drawer :title="title" :drawer="drawer" :drawerW="drawerW" @submitFn="submitFn">
            ...
            >
                <div class="dfrb">
                    <el-form-item label="单位名称" :rules="{ required: true, message: '单位名称不得为空' }">
                ...
                <div class="dfrb">
                    <el-form-item label="销售人员" :rules="{ required: true, message: '销售人员不得为空' }">
                    ...
                    >
                        <el-select v-model="fromData.contact" filterable placeholder="请选择客户联系人">
                            <el-option
    ...
    methods: {
        ...
        creatFn() {
            ...
            if (sessionStorage.getItem("userid")) {
                ...
                u = "60C877AB-3B89-44A8-A4EA-0265002DC975"; //当前用户id
            }
        ...
        submitFn() {
            this.$refs.fromData.validate(valid => {
                if (valid) {
                    ...
                    if (sessionStorage.getItem("userid")) {
                        d.creator = sessionStorage.getItem("userid");
                    } else {
