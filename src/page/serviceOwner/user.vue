...
<template>
    <div class="user">
            ...
            >
                ...
                <el-table-column align="center" label="管理者" prop="isAdmin">
                    <template slot-scope="scope">
                        <span
                            class="cp red-font"
                            @click="isAdminFn(scope.row)"
                        >{{ scope.row.isAdmin == 1 ? "是" : "否" }}</span>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <v-drawer :title="title" :drawer="drawer" @submitFn="submitFn">
            <el-form ref="fromData" :model="fromData" label-width="80px" size="medium">
                ...
                <div class="dfrb" v-if="title == '新建用户'">
                    ...
                    >
                        <el-input placeholder="请确认密码" v-model="fromData.password2" show-password></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                ...
                <div class="dfrb">
                    ...
                    <el-form-item
                        label="年龄"
                        prop="user_age"
                        :rules="{pattern: /^[0-9]+$/,message: '请输入数字',trigger: ['blur', 'change']}"
                    >
                        <el-input placeholder="请输入年龄" v-model.trim="fromData.user_age"></el-input>
                    </el-form-item>
                </div>
