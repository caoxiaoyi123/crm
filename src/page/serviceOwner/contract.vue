        ...
        <div class="table-box">
            ...
            >
                <el-table-column
                    ...
                    type="index"
                ></el-table-column>
                <el-table-column align="left" header-align="center" label="合同编号" width="120" prop="contractNo">
                ...
                <el-table-column align="center" label="签订时间" width="120" prop="confirmDate"></el-table-column>
                ...
                <el-table-column align="center" label="销售姓名" width="90" prop="userName"></el-table-column>
                <el-table-column align="center" label="收入类型" width="125" prop="incomeType"></el-table-column>
                <el-table-column align="left" header-align="center" label="业主单位/甲方" width="235" prop="comName">
                    <template slot-scope="scope">
                ...
                <el-table-column align="left" header-align="center" label="项目名称" width="220" prop="projName">
                    <template slot-scope="scope">
                ...
                <el-table-column align="left" header-align="center" label="合同单位" width="230" prop="contractUnit">
                    <template slot-scope="scope">
                ...
                <el-table-column align="center" label="上传人" width="80" prop="createName"></el-table-column>
                <el-table-column align="right" header-align="center" label="金额" width="70" prop="amount"></el-table-column>
                <el-table-column align="right" header-align="center" label="回款" width="70" prop="receivedPayments"></el-table-column>
                <el-table-column align="center" label="是否开发票" width="120" prop="isTicket">
                    <template slot-scope="scope">
