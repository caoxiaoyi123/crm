...
<template>
    <div class="organize">
        <div class="head-box drc">
            ...
            <span class="drc cp hover-color" @click="deleteFn" v-if="tableData && tableData.length > 0">
        ...
        <div class="table-box">
            ...
            >
                ...
                <el-table-column align="left" header-align="center" label="部门名称" prop="depName">
                ...
                <el-table-column header-align="center" align="left" label="备注" prop="depMemo">
                    <template slot-scope="scope">
        ...
        <v-drawer :title="title" :drawer="drawer" @submitFn="submitFn">
            <el-form :model="fromData" label-width="80px" ref="fromData" size="medium">
                <div class="dfrb">
                    ...
                    >
                        <el-input placeholder="请输入部门名称" v-model="fromData.depName"></el-input>
                    </el-form-item>
                    <el-form-item label="部门负责人" prop="depManager">
                        <el-input placeholder="请输入部门负责人" v-model="fromData.depManager"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                    <el-form-item
                    ...
                    >
                        <el-input placeholder="请输入手机号码" v-model="fromData.depTel"></el-input>
                    </el-form-item>
                    <el-form-item
                        label="邮箱"
                        prop="depMail"
              ...
              trigger: ['blur', 'change']
                    ...
                    >
                        <el-input placeholder="请输入邮箱" v-model="fromData.depMail"></el-input>
                    </el-form-item>
                </div>
