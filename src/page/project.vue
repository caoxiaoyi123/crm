            ...
            >
                ...
                <el-table-column header-align="center" align="left" label="项目名称" prop="projName">
                    <template slot-scope="scope">
                        <span class="text-over" :title="scope.row.projName">{{scope.row.projName}}</span>
                    </template>
                </el-table-column>
                <el-table-column header-align="center" align="left" label="业主名称" prop="comName">
                    <template slot-scope="scope">
                        <span class="text-over" :title="scope.row.comName">{{scope.row.comName}}</span>
                    </template>
                </el-table-column>
                <el-table-column align="center" label="省份" prop="province"></el-table-column>
                <el-table-column align="center" label="服务人员" prop="serviceUser"></el-table-column>
        ...
        <v-drawer :title="title" :drawer="drawer" :drawerW="'803px'" :type="1" @submitFn="submitFn">
            <el-form ref="fromData" :model="fromData" label-width="86px" size="medium">
                ...
                <div class="dfrb">
                    ...
                    >
                        <el-input placeholder="请输入编号" v-model="fromData.projNo"></el-input>
                    </el-form-item>
                    <el-form-item
                        label-width="130px"
                        label="项目名称"
                    ...
                    >
                        <el-input placeholder="请输入项目名称" v-model="fromData.projName"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                    <el-form-item
                    ...
                    >
                        <el-input placeholder="请输入拨款单位" v-model="fromData.projFundcom"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                    <el-form-item label="技术等级" prop="projTechlevel">
                        <el-input placeholder="请输入技术等级" v-model="fromData.projTechlevel"></el-input>
                    </el-form-item>
                ...
                <div class="dfrb">
                    <el-form-item
                        label="计划工期(月)"
                        prop="projDuration"
                        :rules="{pattern: /^(([1-9]\d*)|0)(\.\d+)?$/,message: '计划工期必须为正数',trigger: ['blur', 'change']}"
                    >
                        <el-input placeholder="请输入计划工期" v-model="fromData.projDuration"></el-input>
                    </el-form-item>
                    <el-form-item
                        label-width="130px"
                        label="工期起止时间"
                ...
                <div class="dfrb">
                    <el-form-item
                        label="总投资(万)"
                        prop="projBudget"
                        :rules="{pattern: /^(([1-9]\d*)|0)(\.\d+)?$/,message: '总投资必须为正数',trigger: ['blur', 'change']}"
                    >
                        <el-input placeholder="请输入总投资" v-model="fromData.projBudget"></el-input>
                    </el-form-item>
                    <el-form-item
                        label-width="130px"
                        label="里程"
                        prop="projDistance"
                        :rules="{pattern: /^(([1-9]\d*)|0)(\.\d+)?$/,message: '里程必须为正数',trigger: ['blur', 'change']}"
                    >
                        <el-input placeholder="请输入里程" v-model="fromData.projDistance"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                    <el-form-item label="起始桩号" prop="projStartstake">
                        <el-input placeholder="请输入起始桩号" v-model="fromData.projStartstake"></el-input>
                    </el-form-item>
                    <el-form-item label-width="130px" label="终点桩号" prop="projEndstake">
                        <el-input placeholder="请输入终点桩号" v-model="fromData.projEndstake"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                    ...
                    <el-form-item label-width="130px" label="计划子类" prop="projPlanchildtype">
                        <el-select
                ...
                <el-form-item
                    ...
                    :rules="{pattern: /^(([1-9]\d*)|0)(\.\d+)?$/,message: '建安费必须为正数',trigger: ['blur', 'change']}"
                >
                    <el-input placeholder="请输入建安费" v-model="fromData.projConstruction" style="width:202px"></el-input>
                </el-form-item>
                ...
                <div class="dfrb">
                    <el-form-item label="责任领导" prop="responsibilityLeader">
                        <el-input placeholder="请输入责任领导" v-model="fromData.responsibilityLeader"></el-input>
                    </el-form-item>
                    <el-form-item
                        label-width="130px"
                        label="项目经理手机号码"
                        prop="projectManagerTel"
                        :rules="{pattern: /^((13[0-9])|(15[^4])|(166)|(17[0-8])|(18[0-9])|(19[8-9])|(147,145))\d{8}$/,message: '请输入正确的手机号码',trigger: ['blur', 'change']}"
                    >
                        <el-input placeholder="请输入项目经理手机号码" v-model="fromData.projectManagerTel"></el-input>
                    </el-form-item>
                </div>
                <el-form-item label="项目经理" prop="projectManager">
                    <el-input placeholder="请输入项目经理" v-model="fromData.projectManager" style="width:202px"></el-input>
                </el-form-item>
                <!-- 分割线 -->
                <h4 class="bor-b tit-txt fs16">参建单位</h4>
                <div class="dfrb">
                    <el-form-item label="设计单位" prop="designUnit">
                        <el-input placeholder="请输入设计单位" v-model="fromData.designUnit"></el-input>
                    </el-form-item>
                    <el-form-item label-width="130px" label="施工单位" prop="projBuildcoms">
                        <el-input placeholder="请输入施工单位" v-model="fromData.projBuildcoms"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                    <el-form-item label="勘测单位" prop="surveyUnit">
                        <el-input placeholder="请输入勘测单位" v-model="fromData.surveyUnit"></el-input>
                    </el-form-item>
                    <el-form-item label-width="130px" label="监理单位" prop="constructionControlUnit">
                        <el-input placeholder="请输入监理单位" v-model="fromData.constructionControlUnit"></el-input>
                    </el-form-item>
                </div>
                <!-- 分割线 -->
                ...
                <div class="dfrb">
                    <el-form-item label="招标单位" prop="bidUnit">
                        <el-input placeholder="请输入招标单位" v-model="fromData.bidUnit"></el-input>
                    </el-form-item>
                ...
                <div class="dfrb">
                    <el-form-item label="招标人" prop="tenderee">
                        <el-input placeholder="请输入招标人" v-model="fromData.tenderee"></el-input>
                    </el-form-item>
                    <el-form-item
                        label-width="130px"
                        label="手机号码"
                        ...
                        :rules="{pattern: /^((13[0-9])|(15[^4])|(166)|(17[0-8])|(18[0-9])|(19[8-9])|(147,145))\d{8}$/,message: '请输入正确的手机号码',trigger: ['blur', 'change']}"
                    >
                        <el-input placeholder="请输入手机号码" v-model="fromData.tendereePhone"></el-input>
                    </el-form-item>
                </div>
                <!-- 分割线 -->
                ...
                <div class="dfrb">
                    <el-form-item label="中标单位" prop="bidWinner">
                        <el-input placeholder="请输入中标单位" v-model="fromData.bidWinner"></el-input>
                    </el-form-item>
                    <el-form-item label-width="130px" label="招标代理机构" prop="bidAgency">
                        <el-input placeholder="请输入招标代理机构" v-model="fromData.bidAgency"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                    <el-form-item label="代理人" prop="agent">
                        <el-input placeholder="请输入代理人" v-model="fromData.agent"></el-input>
                    </el-form-item>
                    <el-form-item label-width="130px" label="代理人电话" prop="agentPhone">
                        <el-input placeholder="请输入代理人电话" v-model="fromData.agentPhone"></el-input>
                    </el-form-item>
                </div>
                <!-- 分割线 -->
                ...
                <div class="dfrb">
                    <el-form-item label="竞争单位" prop="competitiveUnit">
                        <el-input placeholder="请输入竞争单位" v-model="fromData.competitiveUnit"></el-input>
                    </el-form-item>
                    <el-form-item label-width="130px" label="联系人" prop="competitiveUnitLinker">
                        <el-input placeholder="请输入联系人" v-model="fromData.competitiveUnitLinker"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                    <el-form-item label="电话号码" prop="competitiveUnitPhone">
                        <el-input placeholder="请输入电话号码" v-model="fromData.competitiveUnitPhone"></el-input>
                    </el-form-item>
                    <el-form-item label-width="130px" label="品牌名称" prop="competitiveUnitBrand">
                        <el-input placeholder="请输入品牌名称" v-model="fromData.competitiveUnitBrand"></el-input>
                    </el-form-item>
                </div>
                ...
                <div class="dfrb">
                    <el-form-item label="项目关系人" prop="projRelateder">
                        <el-input placeholder="请输入项目关系人" v-model="fromData.projRelateder"></el-input>
                    </el-form-item>
                    <el-form-item label-width="130px" label="项目关系人电话号码" prop="projRelatederPhone">
                        <el-input placeholder="请输入项目关系人电话号码" v-model="fromData.projRelatederPhone"></el-input>
                    </el-form-item>
                </div>
                <!-- 分割线 -->
                ...
                <div class="dfrb">
                    <el-form-item label="内线人" prop="projInsider">
                        <el-input placeholder="请输入内线人"  v-model="fromData.projInsider"></el-input>
                    </el-form-item>
                    <el-form-item label-width="130px" label="内线人电话号码" prop="projInsiderPhone">
                        <el-input placeholder="请输入内线人电话号码"  v-model="fromData.projInsiderPhone"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                    <el-form-item label="内线人职务" prop="projInsiderDuty">
                        <el-input placeholder="请输入内线人职务"  v-model="fromData.projInsiderDuty"></el-input>
                    </el-form-item>
                    <el-form-item label-width="130px" label="内线人性格" prop="projInsiderCharacter">
                        <el-input placeholder="请输入内线人性格"  v-model="fromData.projInsiderCharacter"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                    <el-form-item label="内线人年龄" prop="projInsiderAge">
                        <el-input placeholder="请输入内线人年龄"  v-model="fromData.projInsiderAge"></el-input>
                    </el-form-item>
                    <el-form-item label-width="130px" label="内线人性别" prop="projInsiderSex">
                        <el-input placeholder="请输入内线人性别"  v-model="fromData.projInsiderSex"></el-input>
                    </el-form-item>
                </div>
                ...
                <div class="dfrb">
                    <el-form-item label="决策人" prop="projDecider">
                        <el-input placeholder="请输入决策人"  v-model="fromData.projDecider"></el-input>
                    </el-form-item>
                    <el-form-item label-width="130px" label="决策人电话号码" prop="projDeciderPhone">
                        <el-input placeholder="请输入决策人电话号码"  v-model="fromData.projDeciderPhone"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                    <el-form-item label="决策人职务" prop="projDeciderDuty">
                        <el-input placeholder="请输入决策人职务"  v-model="fromData.projDeciderDuty"></el-input>
                    </el-form-item>
                    <el-form-item label-width="130px" label="决策人性格" prop="projDeciderCharacter">
                        <el-input placeholder="请输入决策人性格"  v-model="fromData.projDeciderCharacter"></el-input>
                    </el-form-item>
                </div>
                <!-- 分割线 -->
