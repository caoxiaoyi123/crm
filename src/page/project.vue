...
<template>
    <div class="project">
        ...
        <div class="table-box">
            <el-table cell-class-name="fs13 table-h" ref="ownList" highlight-current-row  @current-change="tableSelectFn" header-cell-class-name="table-header table-h" border :data="tableData" style="width:100%">
                ...
                <el-table-column header-align="center" align="left" label="业主名称" prop="comName"></el-table-column>
                ...
                <el-table-column align="center" label="是否关闭" prop="isOpen">
                    <template slot-scope="scope">
                        <span class="cp red-font" @click="isOpenFn(scope.row)">{{scope.row.isOpen?'否':'是'}}</span>
                    </template>
                </el-table-column>
        ...
        <v-drawer :title="title" :drawer="drawer" :drawerW="'803px'" :type="1" @submitFn="submitFn">
            <el-form ref="fromData" :model="fromData" label-width="86px" size="medium" >
                ...
                <div class="dfrb">
                    ...
                    <el-form-item  label-width="130px" label="项目名称" prop="projName" :rules="{required:true,message:'项目名称不得为空'}">
                ...
                <div class="dfrb">
                    ...
                    <el-form-item label-width="130px" label="拨款单位" prop="projFundcom" :rules="{required:true,message:'拨款单位不得为空'}">
                ...
                <div class="dfrb">
                    ...
                    <el-form-item label-width="130px" label="计划子类" prop="projPlanchildtype">
                        <el-select v-model="fromData.projPlanchildtype" placeholder="请选择" style="width:202px"  @change="$forceUpdate()">
                            <el-option
                ...
                <div class="dfrb">
                    ...
                    <el-form-item label-width="130px" label="项目类型" prop="projType" :rules="{required:true,message:'项目类型不得为空'}">
                ...
                <div class="dfrb">
                    ...
                    <el-form-item label-width="130px" label="项目经理手机号码" prop="projectManagerTel" :rules="{ pattern:/^((13[0-9])|(15[^4])|(166)|(17[0-8])|(18[0-9])|(19[8-9])|(147,145))\d{8}$/, message: '请输入正确的手机号码', trigger: ['blur', 'change'] }">
                ...
                <div class="dfrb">
                    ...
                    <el-form-item label-width="130px" label="手机号码" prop="tendereePhone" :rules="{ pattern:/^((13[0-9])|(15[^4])|(166)|(17[0-8])|(18[0-9])|(19[8-9])|(147,145))\d{8}$/, message: '请输入正确的手机号码', trigger: ['blur', 'change'] }">
                ...
                <el-form-item label="其他信息" prop="projInsiderInfo">
                    <el-input type="textarea" resize="none" v-model="fromData.projInsiderInfo"></el-input>
                </el-form-item>
                <!-- 分割线 -->
...
export default {
    ...
    methods: {
        ...
        exportFn(){
            window.open('http://192.168.88.192:7001/crm/so/project/excel?comId='+this.data.comId);
        },
