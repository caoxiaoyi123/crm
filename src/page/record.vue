    ...
    <div class="record">
        <div class="head-box drc">
            ...
            <span class="drc">
                ...
                <el-select v-model="data.userId" placeholder="请选择" size="mini" style="width:122px">
                    <el-option
        ...
        <div class="table-box">
            ...
            >
                <el-table-column
                    ...
                    type="index"
                ></el-table-column>
                <el-table-column align="center" label="跟进人" prop="userName"></el-table-column>
                <el-table-column align="center" label="联系日期" prop="recordDate"></el-table-column>
                <el-table-column align="center" label="手机号码" prop="phone"></el-table-column>
                <el-table-column align="center" label="联系方式" prop="lxMethod">
                    <template slot-scope="scope">{{ scope.row.lxMethod | lxMethod }}</template>
                </el-table-column>
                ...
                >
                    <template slot-scope="scope">
                        <span class="text-over" :title="scope.row.recordRemarks">
                            {{
                ...
                <el-table-column align="center" label="下次跟进时间" prop="nextRecordDate"></el-table-column>
                <el-table-column header-align="center" align="left" label="下次跟进思路" prop="nextSl">
                    <template slot-scope="scope">
                        <span class="text-over" :title="scope.row.nextSl">
                            {{
                            scope.row.nextSl
                            }}
                        </span>
                ...
                <el-table-column align="center" label="查看详情">
                    <template slot-scope="scope">
                        <span class="draw-tit cp fs14" @click="seeDetail(scope.row)">查看</span>
                    </template>
                </el-table-column>
            </el-table>
            <v-drawer :title="'查看详情'" :drawer="drawer" :drawerW="'680px'" :readOnly="true">
                <el-form :disabled="true" :model="fromData" label-width="90px" size="medium">
                    ...
                    <div class="dfrb">
                        <el-form-item label="下次跟踪时间" prop="nextRecordDate">
                            <el-input v-model="fromData.nextRecordDate" prefix-icon="el-icon-date"></el-input>
                        </el-form-item>
                        <el-form-item label="联系日期" prop="recordDate">
                            <el-input v-model="fromData.recordDate" prefix-icon="el-icon-date"></el-input>
                        </el-form-item>
                    </div>
                    <div class="dfrb">
                        <el-form-item label="联系方式" prop="lxMethod">
                            <el-input></el-input>
                            <span class="filter-font">{{fromData.lxMethod | lxMethod}}</span>
                            <ul class="file-list" v-if="lxMethodList&&lxMethodList.length>0">
                                <li class="bule-txt fs12 text-over cp" v-for="(item,i) of lxMethodList" :key="i" @click.prevent="openLink(item.fileAddress)">{{item.fileName}}</li>
                            </ul>
                        </el-form-item>
                        <el-form-item label="漏斗阶段" prop="isHk">
                            ...
                            <ul class="file-list" v-if="isHkList&&isHkList.length>0">
                                <li class="bule-txt fs12 text-over cp" v-for="(item,i) of isHkList" :key="i" @click.prevent="openLink(item.fileAddress)">{{item.fileName}}</li>
                            </ul>
                        </el-form-item>
                    </div>
                    <div class="dfrb">
                        <el-form-item label="回款金额(万)" prop="hmoeny" v-if="fromData.hmoeny">
                            <el-input v-model="fromData.hmoeny"></el-input>
                        </el-form-item>
                        <el-form-item label="签约金额(万)" prop="qmoney" v-if="fromData.qmoney">
                            <el-input v-model="fromData.qmoney"></el-input>
                        </el-form-item>
                    </div>
                    <el-form-item label="反思" prop="fs">
                        <el-input type="textarea" resize="none" v-model="fromData.fs"></el-input>
                    </el-form-item>
                    <el-form-item label="下次追踪思路" prop="nextSl">
                        <el-input type="textarea" resize="none" v-model="fromData.nextSl"></el-input>
                    </el-form-item>
                    <el-form-item label="跟踪内容" prop="recordRemarks">
                        <el-input type="textarea" resize="none" v-model="fromData.recordRemarks"></el-input>
                    </el-form-item>
                    <el-form-item label="AB对话" prop="abask">
                        <el-input type="textarea" resize="none" v-model="fromData.abask"></el-input>
                    </el-form-item>
                    <el-form-item label="备注" prop="followContent">
                        <el-input type="textarea" resize="none" v-model="fromData.followContent"></el-input>
                    </el-form-item>
