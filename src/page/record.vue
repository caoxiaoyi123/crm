        ...
        <div class="table-box">
            ...
            >
                ...
                <el-table-column align="center" label="联系方式" prop="lxMethod">
                    <template slot-scope="scope">{{scope.row.lxMethod | lxMethod}}
                    </template>
                </el-table-column>
                ...
                >
                    <template slot-scope="scope">
                        <span class="text-over" :title="scope.row.recordRemarks">{{scope.row.recordRemarks}}</span>
                    </template>
                </el-table-column>
                        ...
                        <div class="layout-box text-c">
                            <span>
                                ...
                                <button
                                    ...
                                    @click="openLink(fromData.qtwdurl)"
                                >点击查看</button>
                            </span>
                        </div>
                    </div>
