    ...
    <div class="record">
        ...
        <div class="table-box">
            <el-table cell-class-name="fs13 table-h" header-cell-class-name="table-header table-h" border :data="tableData" style="width:100%">
                ...
                <el-table-column align="center" label="跟踪内容" prop="recordRemarks"></el-table-column>
                <el-table-column align="center" label="下次跟进时间" prop="nextRecordDate"></el-table-column>
                <el-table-column align="center" label="下次跟进思路" prop="nextSl"></el-table-column>
                ...
                <el-form :disabled="true" :model="fromData" label-width="90px" size="medium">
                    ...
                    <div class="dfrb">
                        <el-form-item label="反思" prop="fs">
                            <el-input v-model="fromData.fs"></el-input>
                        </el-form-item>
                        <el-form-item label="下次追踪思路" prop="nextSl">
                            <el-input v-model="fromData.nextSl"></el-input>
                        </el-form-item>
                    </div>
                    ...
                    <div class="dfrb mb20">
                        <div class="layout-box text-c">
                            <span>
                                ...
                                <button class="see-btn fs12 text-c cp" :class="fromData.hpurl?'':'ban'"  @click="openLink(fromData.hpurl)">点击查看</button>
                            </span>
                        </div>
                        <div class="layout-box text-c">
                            <span>
                                <font class="fs13 file-label">清单</font>
                                <button class="see-btn fs12 text-c cp" :class="fromData.qdurl?'':'ban'"  @click="openLink(fromData.qdurl)">点击查看</button>
                            </span>
                        </div>
                    </div>
                    <div class="dfrb">
                        <div class="layout-box text-c">
                            <span>
                                ...
                                <button class="see-btn fs12 text-c cp" :class="fromData.bdurl?'':'ban'"  @click="openLink(fromData.bdurl)">点击查看</button>
                            </span>
                        </div>
                        <div class="layout-box text-c">
                            <span>
                                <font class="fs13 file-label">其他文档</font>
                                <button class="see-btn fs12 text-c cp" :class="fromData.qtwdurl?'':'ban'" @click="openLink(fromData.qtwdurl)">点击查看</button>
                            </span>
                        </div>
                    </div>
                </el-form>
