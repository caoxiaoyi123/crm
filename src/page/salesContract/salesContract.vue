    ...
    <div class="salesContract">
        <div class="top-box dfrcb">
            ...
            <div class="drc fs13">
                ...
                <span>待回款金额：<font class="red-txt">{{count.waitAmount}}</font>万</span>
            </div>
        </div>
        <div class="table-box">
            <el-table
            ...
            >
                ...
                <el-table-column align="center"  min-width="70" label="地区" prop="province">
                    <template slot-scope="scope">
                ...
                <el-table-column align="center"  min-width="100" label="签订时间" prop="confirmDate"></el-table-column>
                <el-table-column align="center"  min-width="100" label="销售姓名" prop="userName"></el-table-column>
                <el-table-column align="center"  min-width="120" label="收入类型" prop="incomeType"></el-table-column>
                <el-table-column align="left" header-align="center"  min-width="200" label="业主单位/甲方" prop="comName">
                    <template slot-scope="scope">
                ...
                <el-table-column align="left"  min-width="200" header-align="center" label="项目名称" prop="projName">
                    <template slot-scope="scope">
                ...
                <el-table-column align="left"  min-width="200" header-align="center" label="合同单位" prop="contractUnit">
                    <template slot-scope="scope">
                ...
                <el-table-column align="right" header-align="center"  min-width="100" label="金额" prop="amount">
                    <template slot-scope="scope">
                        <span>{{scope.row.amount}}万</span>
                    </template>
                </el-table-column>
                <el-table-column align="right" header-align="center"  min-width="100" label="回款" prop="receivedPayments">
                    <template slot-scope="scope">
                        <span>{{scope.row.receivedPayments}}万</span>
                    </template>
                </el-table-column>
                <el-table-column align="center"  min-width="100" label="是否开发票" prop="isTicket">
                    <template slot-scope="scope">
                ...
                <el-table-column align="center"  min-width="50" label="合同">
                    <template slot-scope="scope">
                        ...
                        <span @click="updownFn(scope.row)" class="cp draw-tit" v-if="scope.row.fileId">下载</span>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <v-drawer :title="title" :drawer="drawer" @submitFn="submitFn">
            <el-form @submit.native.prevent :model="fromData" ref="fromData" label-width="90px" size="medium">
                <div class="dfrb">
                    <el-form-item label="合同编号" prop="contractNo" :rules="{ required: true, message: '合同编号不得为空' }">
                        <el-input placeholder="请输入合同编号" v-model="fromData.contractNo"></el-input>
                    </el-form-item>
                    <el-form-item label="签订时间" prop="confirmDate" :rules="{ required: true, message: '签订时间不得为空' }">
                        <el-date-picker
                ...
                <div class="dfrb">
                    <el-form-item label="收入类型" prop="incomeType" :rules="{ required: true, message: '收入类型不得为空' }">
                        <el-select v-model="fromData.incomeType" placeholder="请选择收入类型" style="width:202px">
                            <el-option
                    ...
                    <el-form-item label="业主单位" prop="comId" :rules="{ required: true, message: '业主单位不得为空' }">
                        <el-select v-model="fromData.comId" filterable placeholder="请选择业主单位" @change="comChange">
                            <el-option
                ...
                <div class="dfrb">
                    <el-form-item label="项目名称" prop="projId" :rules="{ required: true, message: '项目名称不得为空' }">
                        <el-select v-model="fromData.projId" placeholder="请选择项目名称" style="width:202px" >
                            <el-option
                    ...
                    <el-form-item label="合同单位" prop="contractUnit" :rules="{ required: true, message: '合同单位不得为空' }">
                        <el-input placeholder="请输入合同单位" v-model="fromData.contractUnit"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                ...
                <div class="dfrb">
                    <el-form-item label="是否开发票" prop="isTicket" :rules="{ required: true, message: '是否开发票不得为空' }">
                ...
                <div class="dfrb">
                    <el-form-item label="上传合同" style="width:100%" :rules="{ required: true, message: '合同附件为必传' }">
...
export default {
    ...
    data() {
        return {
            ...
            //收入类型list
            incomeList:['OA+门户网站','档案管理','房建','河长/湖长','河长/湖长/路长','监管系统','水利','项目管理平台','智慧工地','智慧劳务','地铁','养护'],
            options: [],//承载地区数组
            userList:[],//销售人员数组
            fileData:{
                data: {
