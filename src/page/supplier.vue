        ...
        <div class="table-box">
            ...
            >
                <el-table-column
                    ...
                    type="index"
                ></el-table-column>
                <el-table-column header-align="center" align="left" label="供应商名称" prop="comName">
            ...
            <el-form :model="fromData" label-width="80px" size="medium" ref="fromData">
                <div class="dfrb">
                    ...
                    <div style="display:flex;align-items:end">
                        ...
                        >
                            <el-input placeholder="请输入统一社会信用代码" v-model="fromData.corpCode"></el-input>
                        </el-form-item>
                        <button class="ml10 search-btn cp" @click="searchFn">点击查询</button>
                    </div>
                </div>
                <div class="dfrb" style="padding-right: 74px;">
                    <el-form-item label="所属地区" prop="re" :rules="rules.comRegion" ref="region">
                        <el-cascader
                            placeholder="请选择所属地区"
                            ref="cascader"
                            style="width:202px"
                ...
                <div class="dfrb" style="padding-right: 74px;">
                    ...
                    <el-form-item label="备注" prop="comMemo">
                        <el-input placeholder="请输入备注" v-model="fromData.comMemo"></el-input>
                    </el-form-item>
                </div>
            </el-form>
        </v-drawer>
    ...
    methods: {
        ...
        corpCodeAjax(str, cb) {
            ...
            this.$http({
                method: "get",
                url:
                    "http://api.jizhibao.com.cn/Account/GetCompanyListFromWebSite",
                params: {
