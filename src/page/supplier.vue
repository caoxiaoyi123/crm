...
<template>
    <div class="supplier">
        ...
        <div class="table-box">
            <el-table cell-class-name="fs13 table-h" ref="ownList" @current-change="tableSelectFn"  highlight-current-row header-cell-class-name="table-header table-h" border :data="tableData" style="width:100%">
                <el-table-column align="center" class-name="serial-num" width="50px" label="序号" type="index"></el-table-column>
                <el-table-column align="center" label="供应商名称" prop="comName"></el-table-column>
                <el-table-column align="center" label="负责人" prop="comManager"></el-table-column>
                <el-table-column align="center" label="手机号码" prop="comPhone"></el-table-column>
        ...
        <v-drawer :title="title" :drawer="drawer" :drawerW="'850px'"  @submitFn="submitFn">
            <el-form :model="fromData" label-width="80px" size="medium" ref="fromData">
                <div class="dfrb">
                    ...
                    <div style="display:flex;align-items:end">
                        <el-form-item label-width="126px" label="统一社会信用代码" prop="corpCode" :rules="rules.corpCode">
                            <el-input v-model="fromData.corpCode"></el-input>
                        </el-form-item>
                        <button class="ml10 search-btn cp" @click="searchFn">点击查询</button>
                    </div>
                </div>
                <div class="dfrb" style="padding-right: 74px;">
                    <el-form-item label="所属地区" prop="comRegion" :rules="rules.comRegion" ref="region">
                ...
                <div class="dfrb" style="padding-right: 74px;">
                    <el-form-item label="手机号码" prop="comPhone" :rules="rules.comPhone">
                ...
                <div class="dfrb" style="padding-right: 74px;">
                    <el-form-item label="电子邮箱" prop="comEmail" :rules="rules.comEmail">
                ...
                <div class="dfrb" style="padding-right: 74px;">
                    ...
                    <el-form-item label="备注" prop="comMemo">
                        <el-input v-model="fromData.comMemo"></el-input>
                    </el-form-item>
                </div>
            </el-form>
        </v-drawer>
...
export default {
        ...
        return {
            ...
            rules:{
                ...
                corpCode:[
                    ...
                    {pattern:/^([0-9A-HJ-NPQRTUWXY]{2}\d{6}[0-9A-HJ-NPQRTUWXY]{10})$/,message:'请输入正确的统一社会信用代码',trigger:['blur', 'change']}
                ],
                comRegion:{required:true,message:'所属地区不得为空'},
                comPhone:{pattern:/^((13[0-9])|(15[^4])|(166)|(17[0-8])|(18[0-9])|(19[8-9])|(147,145))\d{8}$/, message: '请输入正确的手机号码', trigger: ['blur', 'change'] },
                comEmail:{ type: 'email', message: '请输入正确的邮箱地址', trigger: ['blur', 'change'] }
            }
        }
    },
    components:{
    ...
    methods: {
        ...
        searchFn(){//根据公司名称跳到信用中国
            if(this.fromData.comName&&this.fromData.comName!=''){
                window.open('https://www.creditchina.gov.cn/xinyongxinxi/index.html?index=0&scenes=defaultScenario&tableName=credit_xyzx_tyshxydm&searchState=2&entityType=1,2,4,5,6,7,8&keyword='+this.fromData.comName)
            }else{
                this.$notify({
                    title: '警告',
                    message: '公司名称不得为空',
