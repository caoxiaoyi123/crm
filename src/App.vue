<template>
    <div id="app">
        <el-container>
            <el-container>
                <!-- 侧边栏 -->
                <el-aside width="170px" style="height:calc(100vh);padding-top: 17px;box-sizing: border-box;">
                    <ul class="prov">
                        <h5 class="fs13">区域</h5>
                    ...
                    <div class="main-top">
                        ...
                        <div class="table-box">
                            ...
                            >
                                ...
                                <el-table-column header-align="center" align="left" fixed label="名称" min-width="182" prop="comName">
                                    <template slot-scope="scope">
        ...
        <v-drawer :title="'修改业主信息'" :drawer="drawer" @submitFn="submitFn">
            <el-form :model="fromData" ref="fromData" label-width="80px" size="medium">
                <div class="dfrb">
                    ...
                    >
                        <el-input placeholder="请输入单位名称" v-model="fromData.comName"></el-input>
                    </el-form-item>
                    <el-form-item
                        label="负责人"
                        prop="comManager"
                    ...
                    >
                        <el-input placeholder="请输入负责人" v-model="fromData.comManager"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                    <el-form-item
              ...
              { required: true, message: '手机号码不得为空' },
              {
                ...
                trigger: ['blur', 'change']
                    ...
                    >
                        <el-input placeholder="请输入手机号码" v-model="fromData.comPhone"></el-input>
                    </el-form-item>
                    <el-form-item label="电话" prop="comTel">
                        <el-input placeholder="请输入电话" v-model="fromData.comTel"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                    <el-form-item label="地址" prop="comAddr">
                        <el-input placeholder="请输入地址" v-model="fromData.comAddr"></el-input>
                    </el-form-item>
                    <el-form-item
                        label="电子邮箱"
                        prop="comEmail"
                    ...
                    >
                        <el-input placeholder="请输入电子邮箱" v-model="fromData.comEmail"></el-input>
                    </el-form-item>
                </div>
                <div class="dfrb">
                    <el-form-item label="传真" prop="comFax">
                        <el-input placeholder="请输入传真" v-model="fromData.comFax"></el-input>
                    </el-form-item>
                ...
                <div class="dfrb">
                    <el-form-item label="网址" prop="comWeb">
                        <el-input  placeholder="请输入网址" v-model="fromData.comWeb"></el-input>
                    </el-form-item>
                    <el-form-item label="系统名称" prop="comSystemname">
                        <el-input  placeholder="请输入系统名称" v-model="fromData.comSystemname"></el-input>
                    </el-form-item>
                </div>
                <el-form-item label="备注" prop="comMemo">
                    <el-input placeholder="请输入备注" type="textarea" resize="none" v-model="fromData.comMemo"></el-input>
                </el-form-item>
            </el-form>
        </v-drawer>
    </div>
