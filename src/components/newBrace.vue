    ...
    <div class="newBrace">
        ...
        <div class="table-box">
            ...
            >
                ...
                <el-table-column align="center" width="50" label="序号" type="index" :index="indexFn"></el-table-column>
                ...
                <el-table-column align="left" header-align="center"  min-width="150" label="单位名称" prop="comName">
                    <template slot-scope="scope">
